...
/// makro za podesavanje visoke vrednosti signala
#define HIGH 1
/// makro za podesavanje niske vrednosti signala
#define LOW 0
...
/// broj milisekundi od pocetka izvrasanja programa
volatile unsigned long ms = 0;

/**
 * pinPulse - funkcija koja implementira trepet
 * @param port - input tipa unsigned char - Port na kome je potrebno implementirati treptaj
